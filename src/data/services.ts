      ...
      items: [
        {
          ...
          price: 91,
          description: "Length, waist, or thigh-to-bottom alteration",
          time: "24-48 hours",
          image: maleJeans,
          variants: [
            { name: "Length", price: 91 },
            { name: "Waist (with Dot / dart)", price: 91 },
            { name: "Waist (with waistband)", price: 341 },
            { name: "Thigh to Bottom (only side)", price: 141 },
            { name: "Thigh to Bottom (major side)", price: 241 },
          ],
        },
        {
          id: "male-chinos",
        ...
        },
        {
          ...
          subcategory: "bottom-wear",
          price: 91,
          description: "Length, waist, thigh-to-bottom or full fitting alteration",
          time: "24-48 hours",
          image: maleTrousers,
          variants: [
            { name: "Length", price: 91 },
            { name: "Waist", price: 141 },
            { name: "Thigh to Bottom", price: 141 },
            { name: "Full Fitting", price: 351 },
          ],
        },
        {
          id: "male-pyjama",
        ...
        },
        {
          ...
          subcategory: "bottom-wear",
          price: 91,
          description: "Length, waistband or dot adjustment",
          time: "24 hours",
          image: maleShorts,
          variants: [
            { name: "Length", price: 91 },
            { name: "Waistband Alter", price: 341 },
            { name: "Dot (waist dart)", price: 91 },
          ],
        },
      ],
    },
